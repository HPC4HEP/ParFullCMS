...
set_target_properties(G4analysis PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "G4global;G4intercoms;G4zlib;/usr/lib64/libexpat.so"
...
# Import target "G4geomUSolids" for configuration "Release"
set_property(TARGET G4geomUSolids APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(G4geomUSolids PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libG4geomUSolids.so"
  IMPORTED_SONAME_RELEASE "libG4geomUSolids.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS G4geomUSolids )
list(APPEND _IMPORT_CHECK_FILES_FOR_G4geomUSolids "${_IMPORT_PREFIX}/lib64/libG4geomUSolids.so" )
...
set_target_properties(G4geometry PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "G4global;G4graphics_reps;G4intercoms;G4materials;G4geomUSolids"
...
set_target_properties(G4persistency PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "G4geometry;G4global;G4graphics_reps;G4intercoms;G4materials;G4particles;G4digits_hits;G4event;G4processes;G4run;G4track;G4tracking;/usr/local/lib/libxerces-c.so"
...
set_target_properties(G4processes PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "G4digits_hits;G4geometry;G4global;G4intercoms;G4materials;G4particles;G4track;/usr/lib64/libexpat.so;G4zlib"
...
set_target_properties(G4modeling PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "G4digits_hits;G4run;G4event;G4geometry;G4global;G4graphics_reps;G4intercoms;G4materials;G4particles;G4processes;G4track;G4tracking"
